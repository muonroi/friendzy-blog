    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_AppRoleClaims", x => x.Id);
                });
            ...
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_AppUserClaims", x => x.Id);
                });
            ...
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_AppUserLogins", x => x.UserId);
                });
            ...
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_AppUserRoles", x => new { x.RoleId, x.UserId });
                });
            ...
            _ = migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    _ = table.PrimaryKey("PK_AppUserTokens", x => x.UserId);
                });
